...
pub use self::readiness::{
    ...
    lock_anchors, lost_fetchability, promote, promote_closure, recount_demanded, repair_pending,
    seed_unready_deps, unpromote_drv_owners, unpromote_ungated, unwalk_derivations,
};
