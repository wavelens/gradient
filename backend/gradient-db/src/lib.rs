...
pub use self::cache_storage::{
    MissingInputDiagnosis, STORAGE_HEADROOM_BYTES, UnbackedSweep, UnconfirmedPath,
    cache_used_bytes, demote_cached_output, demote_output_only_cached_deps, demote_referrers_of,
