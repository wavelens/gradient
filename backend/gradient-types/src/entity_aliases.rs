...
pub type ECacheInvitation = cache_invitation::Entity;
pub type ECacheSubscriptionRequest = cache_subscription_request::Entity;
...
pub type EDerivationBuild = derivation_build::Entity;
pub type EDerivationClosure = derivation_closure::Entity;
pub type EDerivationDependency = derivation_dependency::Entity;
pub type EDerivationInputSource = derivation_input_source::Entity;
...
pub type EDebugInfo = debug_info::Entity;
pub type EEntryPoint = entry_point::Entity;
pub type EEntryPointDepCount = entry_point_dep_count::Entity;
pub type EEntryPointMessage = entry_point_message::Entity;
pub type EEvalCacheStore = eval_cache_store::Entity;
...
pub type EProjectBaseWorker = project_base_worker::Entity;
pub type AProjectBaseWorker = project_base_worker::ActiveModel;
pub type EProjectCache = project_cache::Entity;
pub type EProjectInvitation = project_invitation::Entity;
pub type EProjectUser = project_user::Entity;
pub type ETask = task::Entity;
pub type ETaskAction = task_action::Entity;
pub type ETaskActionDelivery = task_action_delivery::Entity;
pub type ETaskFlakeInputOverride = task_flake_input_override::Entity;
pub type ETaskTrigger = task_trigger::Entity;
...
pub type MCacheInvitation = cache_invitation::Model;
pub type MCacheSubscriptionRequest = cache_subscription_request::Model;
...
pub type MDerivationBuild = derivation_build::Model;
pub type MDerivationClosure = derivation_closure::Model;
pub type MDerivationDependency = derivation_dependency::Model;
pub type MDerivationInputSource = derivation_input_source::Model;
...
pub type MDebugInfo = debug_info::Model;
pub type MEntryPoint = entry_point::Model;
pub type MEntryPointDepCount = entry_point_dep_count::Model;
pub type MEntryPointMessage = entry_point_message::Model;
pub type MEvalCacheStore = eval_cache_store::Model;
...
pub type MFlakeOutputNode = flake_output_node::Model;
pub type MFeature = feature::Model;
pub type MIntegration = integration::Model;
pub type MProject = project::Model;
pub type MProjectCache = project_cache::Model;
pub type MProjectInvitation = project_invitation::Model;
pub type MProjectUser = project_user::Model;
pub type MTask = task::Model;
pub type MTaskAction = task_action::Model;
pub type MTaskActionDelivery = task_action_delivery::Model;
pub type MTaskFlakeInputOverride = task_flake_input_override::Model;
pub type MTaskTrigger = task_trigger::Model;
...
pub type ACacheInvitation = cache_invitation::ActiveModel;
pub type ACacheSubscriptionRequest = cache_subscription_request::ActiveModel;
...
pub type ADerivationBuild = derivation_build::ActiveModel;
pub type ADerivationClosure = derivation_closure::ActiveModel;
pub type ADerivationDependency = derivation_dependency::ActiveModel;
pub type ADerivationInputSource = derivation_input_source::ActiveModel;
...
pub type ADebugInfo = debug_info::ActiveModel;
pub type AEntryPoint = entry_point::ActiveModel;
pub type AEntryPointDepCount = entry_point_dep_count::ActiveModel;
pub type AEntryPointMessage = entry_point_message::ActiveModel;
pub type AEvalCacheStore = eval_cache_store::ActiveModel;
...
pub type AFlakeOutputNode = flake_output_node::ActiveModel;
pub type AFeature = feature::ActiveModel;
pub type AIntegration = integration::ActiveModel;
pub type AProject = project::ActiveModel;
pub type AProjectCache = project_cache::ActiveModel;
pub type AProjectInvitation = project_invitation::ActiveModel;
pub type AProjectUser = project_user::ActiveModel;
pub type ATask = task::ActiveModel;
pub type ATaskAction = task_action::ActiveModel;
pub type ATaskActionDelivery = task_action_delivery::ActiveModel;
pub type ATaskFlakeInputOverride = task_flake_input_override::ActiveModel;
pub type ATaskTrigger = task_trigger::ActiveModel;
...
pub type CCacheInvitation = cache_invitation::Column;
pub type CCacheSubscriptionRequest = cache_subscription_request::Column;
...
pub type CDerivationBuild = derivation_build::Column;
pub type CDerivationClosure = derivation_closure::Column;
pub type CDerivationDependency = derivation_dependency::Column;
pub type CDerivationInputSource = derivation_input_source::Column;
...
pub type CDebugInfo = debug_info::Column;
pub type CEntryPoint = entry_point::Column;
pub type CEntryPointDepCount = entry_point_dep_count::Column;
pub type CEntryPointMessage = entry_point_message::Column;
pub type CEvalCacheStore = eval_cache_store::Column;
...
pub type CProjectCache = project_cache::Column;
pub type CProjectInvitation = project_invitation::Column;
pub type CProjectUser = project_user::Column;
pub type CTask = task::Column;
pub type CTaskAction = task_action::Column;
pub type CTaskActionDelivery = task_action_delivery::Column;
pub type CTaskFlakeInputOverride = task_flake_input_override::Column;
pub type CTaskTrigger = task_trigger::Column;
