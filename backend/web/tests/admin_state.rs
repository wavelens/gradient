...
use test_support::fixtures::user;
...
fn superuser() -> entity::user::Model {
    entity::user::Model {
        superuser: true,
        ..user()
    }
...
/// auth middleware.
fn with_user(db: MockDatabase, session_id: SessionId, caller: entity::user::Model) -> MockDatabase {
...
fn with_empty_export(db: MockDatabase) -> MockDatabase {
    db.append_query_results([Vec::<entity::user::Model>::new()])
        .append_query_results([Vec::<entity::organization::Model>::new()])
        .append_query_results([Vec::<entity::project::Model>::new()])
        .append_query_results([Vec::<entity::cache::Model>::new()])
        .append_query_results([Vec::<entity::role::Model>::new()])
        .append_query_results([Vec::<entity::cache_role::Model>::new()])
        .append_query_results([Vec::<entity::api::Model>::new()])
        ...
        .append_query_results([Vec::<entity::cache_upstream::Model>::new()])
