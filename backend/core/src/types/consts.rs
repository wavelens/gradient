...
pub const BASE_CACHE_ROLE_ADMIN_ID: RoleId = RoleId::new(uuid!("00000000-0000-0000-0000-000000000011"));
pub const BASE_CACHE_ROLE_WRITE_ID: RoleId = RoleId::new(uuid!("00000000-0000-0000-0000-000000000012"));
pub const BASE_CACHE_ROLE_VIEW_ID: RoleId = RoleId::new(uuid!("00000000-0000-0000-0000-000000000013"));
