...
SECRET_KEY = (
    open(SECRET_KEY_FILE).read().strip()
    if SECRET_KEY_FILE
    else "django-insecure-8aa0=fofed&)*3(3v)b39@vm@zxsqss=#5asynz9ru4=zm6$e6"
)
...
GRADIENT_OIDC_ENABLED = os.environ.get("GRADIENT_OIDC_ENABLED", "false") == "true"
GRADIENT_OIDC_REQUIRED = os.environ.get("GRADIENT_OIDC_REQUIRED", "false") == "true"
GRADIENT_OIDC_ICON_URL = os.environ.get("GRADIENT_OIDC_ICON_URL", "")
GRADIENT_EMAIL_ENABLED = os.environ.get("GRADIENT_EMAIL_ENABLED", "false") == "true"
GRADIENT_EMAIL_REQUIRE_VERIFICATION = (
    os.environ.get("GRADIENT_EMAIL_REQUIRE_VERIFICATION", "false") == "true"
)
