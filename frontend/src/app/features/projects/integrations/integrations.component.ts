...
export class IntegrationsComponent implements OnInit {
  ...
  createIntegration(): void {
    ...
    if (this.formData.forge_type === 'github') {
      ...
      this.integrationsService.createProjectIntegration(this.projectName, body).subscribe({
        next: () => {
  ...
  saveEdit(): void {
    ...
    this.integrationsService.patchProjectIntegration(this.projectName, target.id, body).subscribe({
      next: () => {
        this.saving.set(false);
  ...
  clearSecret(): void {
    ...
    this.integrationsService
      .patchProjectIntegration(this.projectName, target.id, { secret: '' })
      .subscribe({
        next: () => {
          this.saving.set(false);
          this.loadIntegrations();
  ...
  clearAccessToken(): void {
    ...
    this.errorMessage.set(null);
    this.integrationsService
      .patchProjectIntegration(this.projectName, target.id, { access_token: '' })
      .subscribe({
        next: () => {
          this.saving.set(false);
          this.loadIntegrations();
  ...
  deleteIntegration(integration: Integration): void {
    ...
    this.integrationsService.deleteProjectIntegration(this.projectName, integration.id).subscribe({
      next: () => {
