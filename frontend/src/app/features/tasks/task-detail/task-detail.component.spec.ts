...
describe('TaskDetailComponent - in-progress state (#452)', () => {
...
describe('TaskDetailComponent - error surfacing (issue #280)', () => {
...
describe('TaskDetailComponent - evaluation selection', () => {
...
describe('TaskDetailComponent - abort modal', () => {
