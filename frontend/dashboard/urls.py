...
urlpatterns = [
    ...
    path(
        "organization/<str:org>/project/<str:project>",
        project_detail,
        name="projectDetail",
    ),
    path(
        "organization/<str:org>/project/<str:project>/start",
        start_evaluation,
        name="startEvaluation",
    ),
    path(
        "organization/<str:org>/project/<str:project>/abort",
        abort_evaluation,
        name="abortEvaluation",
    ),
    ...
    path(
        "organization/<str:org>/download/<str:evaluation_id>",
        download,
        name="download-eval",
    ),
    ...
    path(
        "organization/<str:org>/project/<str:project>/settings",
        edit_project,
        name="settingsProject",
    ),
    path(
        "organization/<str:org>/project/<str:project>/delete",
        delete_project,
        name="deleteProject",
    ),
    path(
        "organization/<str:org>/settings",
        edit_organization,
        name="settingsOrganization",
    ),
    path(
        "organization/<str:org>/delete", delete_organization, name="deleteOrganization"
    ),
    path(
        "organization/<str:org>/members",
        organization_members,
        name="organizationMembers",
    ),
    path(
        "organization/<str:org>/servers",
        organization_servers,
        name="organizationServers",
    ),
    path("organization/<str:org>/ssh", organization_ssh, name="organizationSSH"),
    path(
        "organization/<str:org>/ssh/generate",
        organization_ssh_generate,
        name="organizationSSHGenerate",
    ),
